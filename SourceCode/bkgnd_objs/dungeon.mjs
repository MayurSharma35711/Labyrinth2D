...
class D_Room{
    ...
    start_x;
    start_y;
    constructor(x_len, y_len, x_init, y_init){
        this.size_x = x_len
        this.size_y = y_len
        this.start_x = x_init
        this.start_y = y_init
...
function dung_type_1(){
    let room1 = new D_Room(5, 4, 0, 0)
    let room2 = new D_Room(3, 6, 8, 2)
    let room3 = new D_Room(2, 4, 15, 3)
    let room4 = new D_Room(6, 2, 13, 9)

    let corridors = []
    corridors.push([[5,1],[6, 1], [8, 1], [7, 1]])

    return [[room1, room2, room3, room4], corridors]
}
