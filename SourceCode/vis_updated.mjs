...
await PIXI.Assets.load('/Labyrinth2D/Textures/bkgnd/Dungeon.png');
await PIXI.Assets.load('/Labyrinth2D/Textures/bkgnd/blank.png');
await PIXI.Assets.load('/Labyrinth2D/Textures/bkgnd/RoomFloor.png');
